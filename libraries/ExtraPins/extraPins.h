...
public:
    ...
    virtual static void digitalWrite(uint8_t pin, uint8_t value) = 0;
    virtual static uint8_t digitalRead(uint8_t pin) = 0;
    virtual static void pinMode(uint8_t pin, uint8_t mode) = 0;
